...
pub use types::{
    ...
    FullContext, LifecycleEvent, LifecycleEventType, LineageId, Location, LogCheckpoint,
    LogConsistencyProof, LogInclusion, LogLeaf, PublishRequest, PublishResponse, RegistryState,
    SearchParams, SearchResponse, Status, Visibility, WireError,
};
